...
idle_timers = [
   IdleTimer(300, action=lazy.spawn("~/.config/qtile/scripts/screen_dimmer.sh"), resume=lazy.spawn("~/.config/qtile/scripts/restore_screen.sh")),
   IdleTimer(900, action=lazy.spawn("~/.config/qtile/scripts/screen_off.sh"))
]
