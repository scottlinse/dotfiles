...
ShellRoot {
    ...
    property var workspaceKanji: ({ 1: "一", 2: "二", 3: "三", 4: "四", 5: "五", 6: "六", 7: "七", 8: "八", 9: "九", 10: "十" })
    ...
    Process {
        id: weatherProc
        command: [ "wttrbar", "--location", "Portland", "--nerd", "--fahrenheit" ]
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                try {
                    ...
                    weatherText = obj.text ?? ""
                    weatherTooltip = obj.tooltip ?? ""
                } catch (e) {
                    console.warn("wttrbar parse failed:", e)
                }
            }
        }
...
//                        Image {
//                            anchors.fill: parent
//                            source: "file:///home/scott/.config/quickshell/icons/tonybtw.png"
...
//                    }
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            Text {
                                text: root.workspaceKanji[index + 1] ?? (index + 1)
